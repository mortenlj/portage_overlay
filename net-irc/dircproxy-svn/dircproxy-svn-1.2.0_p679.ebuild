...
#svn co --password "" --username dircproxy http://67.205.72.156/svn/dircproxy/trunk@679
ESVN_REPO_URI="http://67.205.72.156/svn/dircproxy/trunk@${REVISION}"
...
ESVN_OPTIONS="--password \"\" --username dircproxy"
