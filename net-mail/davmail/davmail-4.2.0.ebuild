...
EANT_GENTOO_CLASSPATH="commons-codec,commons-httpclient-3,htmlcleaner,jcifs-1.1,log4j,swt-3.6,stax2-api,javamail,servlet-api-2.5,wstx-4.1"
...
src_prepare() {
	...
	find src/ -name "DavService*" -delete || die
}
